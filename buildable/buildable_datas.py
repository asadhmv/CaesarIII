...
buildable_cost: dict[Enum, int] = {
    ...
    BuildingTypes.CERES: 50,
    BuildingTypes.MARS: 50,
    BuildingTypes.MERCURY: 50,
    BuildingTypes.VENUS: 50,
    BuildingTypes.NEPTUNE: 50,
...
buildable_size: dict[BuildingTypes | RoadTypes, tuple[int, int]] = {
    ...
    BuildingTypes.CERES: (2, 2),
    BuildingTypes.MARS: (2, 2),
    BuildingTypes.MERCURY: (2, 2),
    BuildingTypes.VENUS: (2, 2),
    BuildingTypes.NEPTUNE: (2, 2),
