...
class Textures:
    ...
    def init(screen):
        Textures.textures = {
            ...
            BuildingTypes.CASTLE: pg.transform.scale2x(pg.image.load(os.path.join(IMAGE_PATH, 'rCastle.png'))).convert_alpha(screen),
        ...
        Textures.walker_textures = {
            ...
            WalkerTypes.ATTACKER: {
                OrientationTypes.TOP_LEFT: {
                    0: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01039.png')).convert_alpha(screen),
                    1: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01047.png')).convert_alpha(screen),
                    2: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01055.png')).convert_alpha(screen),
                    3: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01063.png')).convert_alpha(screen),
                    4: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01071.png')).convert_alpha(screen),
                    5: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01079.png')).convert_alpha(screen),
                    6: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01087.png')).convert_alpha(screen),
                    7: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01095.png')).convert_alpha(screen),
                    8: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01103.png')).convert_alpha(screen),
                    9: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01111.png')).convert_alpha(screen),
                    10: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01119.png')).convert_alpha(screen),
                    11: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01127.png')).convert_alpha(screen),
                },
                OrientationTypes.TOP_RIGHT: {
                    0: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01033.png')).convert_alpha(screen),
                    1: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01041.png')).convert_alpha(screen),
                    2: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01049.png')).convert_alpha(screen),
                    3: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01057.png')).convert_alpha(screen),
                    4: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01065.png')).convert_alpha(screen),
                    5: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01073.png')).convert_alpha(screen),
                    6: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01081.png')).convert_alpha(screen),
                    7: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01089.png')).convert_alpha(screen),
                    8: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01097.png')).convert_alpha(screen),
                    9: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01105.png')).convert_alpha(screen),
                    10: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01113.png')).convert_alpha(screen),
                    11: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01121.png')).convert_alpha(screen),
                },
                OrientationTypes.BOTTOM_RIGHT: {
                    0: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01035.png')).convert_alpha(screen),
                    1: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01043.png')).convert_alpha(screen),
                    2: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01051.png')).convert_alpha(screen),
                    3: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01059.png')).convert_alpha(screen),
                    4: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01067.png')).convert_alpha(screen),
                    5: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01075.png')).convert_alpha(screen),
                    6: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01083.png')).convert_alpha(screen),
                    7: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01091.png')).convert_alpha(screen),
                    8: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01099.png')).convert_alpha(screen),
                    9: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01107.png')).convert_alpha(screen),
                    10: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01115.png')).convert_alpha(screen),
                    11: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01123.png')).convert_alpha(screen),
                },
                OrientationTypes.BOTTOM_LEFT: {
                    0: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01037.png')).convert_alpha(screen),
                    1: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01045.png')).convert_alpha(screen),
                    2: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01053.png')).convert_alpha(screen),
                    3: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01061.png')).convert_alpha(screen),
                    4: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01069.png')).convert_alpha(screen),
                    5: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01077.png')).convert_alpha(screen),
                    6: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01085.png')).convert_alpha(screen),
                    7: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01093.png')).convert_alpha(screen),
                    8: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01101.png')).convert_alpha(screen),
                    9: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01109.png')).convert_alpha(screen),
                    10: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01117.png')).convert_alpha(screen),
                    11: pg.image.load(os.path.join(IMAGE_PATH, 'rCitizen01_01125.png')).convert_alpha(screen),
                },
            }
        }
