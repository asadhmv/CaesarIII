...
class Menu:
    ...
    def add_input_listener(self):
        EventManager.register_key_listener(pg.K_a, self.add_text, ['a'])
        EventManager.register_key_listener(pg.K_b, self.add_text, ['b'])
        EventManager.register_key_listener(pg.K_c, self.add_text, ['c'])
        EventManager.register_key_listener(pg.K_d, self.add_text, ['d'])
        EventManager.register_key_listener(pg.K_e, self.add_text, ['e'])
        EventManager.register_key_listener(pg.K_f, self.add_text, ['f'])
        EventManager.register_key_listener(pg.K_g, self.add_text, ['g'])
        EventManager.register_key_listener(pg.K_h, self.add_text, ['h'])
        EventManager.register_key_listener(pg.K_i, self.add_text, ['i'])
        EventManager.register_key_listener(pg.K_j, self.add_text, ['j'])
        EventManager.register_key_listener(pg.K_k, self.add_text, ['k'])
        EventManager.register_key_listener(pg.K_l, self.add_text, ['l'])
        EventManager.register_key_listener(pg.K_m, self.add_text, ['m'])
        EventManager.register_key_listener(pg.K_n, self.add_text, ['n'])
        EventManager.register_key_listener(pg.K_o, self.add_text, ['o'])
        EventManager.register_key_listener(pg.K_p, self.add_text, ['p'])
        EventManager.register_key_listener(pg.K_q, self.add_text, ['q'])
        EventManager.register_key_listener(pg.K_r, self.add_text, ['r'])
        EventManager.register_key_listener(pg.K_s, self.add_text, ['s'])
        EventManager.register_key_listener(pg.K_t, self.add_text, ['t'])
        EventManager.register_key_listener(pg.K_u, self.add_text, ['u'])
        EventManager.register_key_listener(pg.K_v, self.add_text, ['v'])
        EventManager.register_key_listener(pg.K_w, self.add_text, ['w'])
        EventManager.register_key_listener(pg.K_x, self.add_text, ['x'])
        EventManager.register_key_listener(pg.K_y, self.add_text, ['y'])
        EventManager.register_key_listener(pg.K_z, self.add_text, ['z'])
        EventManager.register_key_listener(pg.K_1, self.add_text, ['1'])
        EventManager.register_key_listener(pg.K_2, self.add_text, ['2'])
        EventManager.register_key_listener(pg.K_3, self.add_text, ['3'])
        EventManager.register_key_listener(pg.K_4, self.add_text, ['4'])
        EventManager.register_key_listener(pg.K_5, self.add_text, ['5'])
        EventManager.register_key_listener(pg.K_6, self.add_text, ['6'])
        EventManager.register_key_listener(pg.K_7, self.add_text, ['7'])
        EventManager.register_key_listener(pg.K_8, self.add_text, ['8'])
        EventManager.register_key_listener(pg.K_9, self.add_text, ['9'])
        EventManager.register_key_listener(pg.K_0, self.add_text, ['0'])
        EventManager.register_key_listener(pg.K_SPACE, self.add_text, [' '])
        EventManager.register_key_listener(pg.K_BACKSPACE, self.add_text, ['backspace'])
